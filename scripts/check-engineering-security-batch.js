...
const voteService = read('miniprogram/services/vote-service.js')
const interactionModule = read('miniprogram/utils/plate2-interactions.js')
...
assert(postPage.includes('postService.publishPost('))
assert(postService.includes("callCloudFunction('publishPost'"))
...
assert(zhoubianPostPage.includes('postService.publishPost('))
...
assert(plate2Data.includes('getVoteState(id)'))
assert(voteService.includes("action: 'getVoteState'"))
...
assert(plate2.includes("managePost('editPost'"))
assert(managementModule.includes("managePost('toggleActivity'"))
assert(managementModule.includes("managePost('toggleOrder'"))
assert(managementModule.includes('isover: targetIsOver'))
assert(managementModule.includes('takeorder: targetTakeOrder'))
assert(managementModule.includes("managePost('deletePost'"))
...
assert(interactionModule.includes('postService.bookmarkPost('))
assert(plate2.includes('postService.takeOrder('))
